...
current first-viewport screenshots for the main home and menu surfaces and
attaches the matching reference PNGs to the test report. This keeps the normal
test suite stable while giving us concrete side-by-side artifacts for
pixel-level layout work.
