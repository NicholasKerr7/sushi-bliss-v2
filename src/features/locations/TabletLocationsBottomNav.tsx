      ...
      <ul className="grid grid-cols-5">
        {tabletLocationsNav.map((item) => {
          ...
          return (
            <li key={item.label}>
              <Link
                className={`flex min-h-[48px] flex-col items-center justify-center gap-0.5 rounded-[12px] text-[12px] lg:min-h-[64px] lg:gap-1 lg:text-[13px] min-[1080px]:min-h-[86px] min-[1080px]:gap-2 min-[1080px]:text-[15px] ${
