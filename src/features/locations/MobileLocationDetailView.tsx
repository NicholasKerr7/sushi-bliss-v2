  ...
  return (
    <div className="relative z-10 mx-auto max-w-[430px] pb-16">
      ...
      <div className="mt-7 grid grid-cols-[52px_1fr_52px] items-center">
        ...
        <h1 className="editorial-title text-center text-[24px] uppercase tracking-[0.12em] text-white">
          Location Details
        </h1>
      ...
      <section className="mt-4 overflow-hidden rounded-[18px] border border-[var(--sb-border)] bg-[linear-gradient(145deg,rgba(255,255,255,0.065),rgba(255,255,255,0.02))] shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_22px_60px_rgba(0,0,0,0.42)] backdrop-blur-xl">
        <div className="relative min-h-[198px] p-5">
          <Image
            alt=""
          ...
          <div className="relative z-10 max-w-[72%]">
            ...
            <h2 className="editorial-title mt-4 text-[33px] leading-[1.05] text-[var(--sb-gold-soft)]">
              {location.name}
            </h2>
