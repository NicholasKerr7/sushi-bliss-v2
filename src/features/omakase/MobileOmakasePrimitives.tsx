...
interface MobileOmakaseHeaderProps {
  cartCount: number;
  onOpenCart: () => void;
  unreadNotificationCount: number;
}

/** Shared mobile omakase header with brand, cart, and alerts access. */
export function MobileOmakaseHeader({
  cartCount,
  onOpenCart,
  unreadNotificationCount,
}: MobileOmakaseHeaderProps) {
  return (
...
export function MobileOmakaseBackButton({
  label,
  onClick,
}: {
  label: string;
...
export function MobileOmakasePanel({
  children,
  className,
}: {
  children: ReactNode;
