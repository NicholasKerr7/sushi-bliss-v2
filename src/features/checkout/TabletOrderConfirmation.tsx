...
function ConfirmationBenefitStrip() {
  return (
    <div className="grid grid-cols-4 rounded-[14px] border border-white/10 bg-white/[0.035]">
      {confirmationBenefits.map((benefit) => (
        <div
          className="flex items-center justify-center gap-3 border-r border-white/10 px-4 last:border-r-0"
          key={benefit.label}
        >
