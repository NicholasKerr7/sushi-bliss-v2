...
/** Shared mobile offers header with cart and notification access. */
export function MobileOffersHeader({
  cartCount,
  onOpenCart,
  unreadNotificationCount,
}: MobileOffersHeaderProps) {
  return (
...
export function MobileOffersBackButton({
  label,
  onClick,
}: {
  label: string;
...
export function MobileOffersPanel({
  children,
  className,
}: {
  children: ReactNode;
