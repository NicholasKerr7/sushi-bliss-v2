...
/** Shared mobile loyalty header with cart and notification actions. */
export function MobileLoyaltyHeader({
  cartCount,
  onOpenCart,
}: MobileLoyaltyHeaderProps) {
  return (
...
export function MobileLoyaltyPanel({
  children,
  className,
}: {
  children: ReactNode;
...
export function MobileLoyaltyIconCircle({
  className,
  icon,
  size = 28,
}: {
